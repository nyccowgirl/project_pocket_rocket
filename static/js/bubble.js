...
$(document).ready(() => {
  ...
  $(function(){
    $('#chart-promos').dxChart({
      dataSource: dataSourcePromos,
      commonSeriesSettings: {
          type: 'bubble'
      },
      title: 'Correlation between Total Check-Ins and Total Promotions',
      tooltip: {
          enabled: true,
          location: 'edge',
          customizeTooltip: function (arg) {
              return {
                  text: arg.point.tag + '<br/>Total Check-Ins: ' + arg.argumentText + '<br/>Total Promotions: ' + arg.valueText + '<br/>Total Redemptions: ' + arg.size
              };
          }
      },
      argumentAxis: {
